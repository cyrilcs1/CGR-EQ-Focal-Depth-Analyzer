...
nvrtx = 4;
filename='cgrz1greatrthan35.xlsx';
...
prob=[percentno1;percentno2;percentno3];
probv=[prob(1)/100;(prob(1)+prob(2))/100;(prob(1)+prob(2)+prob(3))/100];
i=1;
 while i<=niter1
    rng('shuffle')
    x=rand(1);
